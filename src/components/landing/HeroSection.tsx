...
import { ArrowRight, MessageCircle, ShieldCheck, Zap, Sparkles, CheckCircle2, MapPin } from 'lucide-react'
import PosPreviewMockup from './PosPreviewMockup'

export default function HeroSection({ onOpenDemoModal }: { onOpenDemoModal: () => void }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5 max-w-md mx-auto">
          <button
            ...
            className="w-full sm:w-auto px-7 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-[14px] rounded-xl shadow-lg shadow-blue-600/25 transition-all hover:translate-y-[-2px] flex items-center justify-center gap-2"
          >
          ...
          <a
            ...
            className="w-full sm:w-auto px-6 py-3.5 bg-white hover:bg-slate-50 border border-slate-300 text-slate-800 font-bold text-[14px] rounded-xl shadow-xs transition-all flex items-center justify-center gap-2"
          >
