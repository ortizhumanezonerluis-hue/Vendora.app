...
exports.startLocalScannerServer = startLocalScannerServer;
exports.stopLocalScannerServer = stopLocalScannerServer;
...
function startLocalScannerServer(mainWindow, port = 4321) {
    if (httpServer) {
        return {
...
function stopLocalScannerServer() {
    if (wss) {
        wss.close();
        wss = null;
    }
